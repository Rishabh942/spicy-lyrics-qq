...
export const Icons = {
  PianoRoll: `<svg class="NoFill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 4v8"/><path d="M11 4v8"/><path d="M15 4v8"/><path d="M19 4v8"/><path d="M3 12h18"/><path d="M7 12v8"/><path d="M11 12v8"/><path d="M15 12v8"/><path d="M19 12v8"/></svg>`,
  LyricsPage: `
